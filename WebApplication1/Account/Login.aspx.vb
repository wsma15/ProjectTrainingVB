...
Public Class Login
                ...
                If reader.Read() Then
                    ...
                    If roleName IsNot Nothing Then
                        ...
                        Else
                            ...
                            Response.Redirect("~/Unauthorized.aspx") ' You can create this page to handle invalid roles
                        End If
                    Else
                        ' Role not found
                        ShowErrorMessage("Invalid role for this user.")
                    End If
                Else
    ...
    Private Sub ShowErrorMessage(ByVal message As String)
        Dim lblErrorMessage As ASPxLabel = CType(FindControl("lblErrorMessage"), ASPxLabel)

        If lblErrorMessage IsNot Nothing Then
